...
tuple<long double, uint8_t, uint8_t> brf (long double n1, uint8_t n2, uint8_t n3 = 1) {
    tuple<long double, uint8_t, uint8_t> gf;
    gf = make_tuple(n1, n2, n3);
    if (pow(n2, n3) == n1)
        return gf;
    else if (pow(n2,n3) > n1)
        return make_tuple(n1,++n2,1);
    else if (n2%4 == 3 && n3 > 16)
